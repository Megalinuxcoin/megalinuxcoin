...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Megalinuxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"megalinuxcointools.com", "dnsseed.megalinuxcointools.com"},
    {"megalinuxcoinpool.org", "dnsseed.megalinuxcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"megalinuxcointools.com", "testnet-seed.megalinuxcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Megalinuxcoin is probably already running."), addrBind.ToString().c_str());
        else
